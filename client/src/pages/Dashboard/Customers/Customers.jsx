...
const Customers = () => {
  const [customers] = useState([
    ...
    },
    {
      ...
      email: "s.rodriguez@designstudio.com",
      ...
      totalSpent: 28750,
      avatar:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT6K7q9HlliqaeipPJpAVw5FTTPoacIIFb_MQ&s",
    },
    {
      id: 3,
      name: "Marcus Chen",
      email: "marcus.chen@financegroup.com",
    ...
    },
    {
      ...
      email: "isabella.t@luxurybrands.com",
        ...
        <tbody>
          {filteredCustomers.map((customer) => (
            <tr key={customer.id}>
              ...
              <td>
                <span
                  className={`${CSS.status} ${getStatusClass(customer.status)}`}
                >
                  {customer.status}
                </span>
              </td>
