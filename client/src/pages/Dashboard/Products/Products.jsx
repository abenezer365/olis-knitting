              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setAddForm({ ...addForm, rating: e.target.value })
                    }
                    className="w-full p-3 border border-accent/20 rounded-lg bg-background focus:outline-none focus:ring-2 focus:ring-accent/30"
                    placeholder="4.0"
                  />
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                  {addForm.colorsArray.map((color, index) => (
                    <span
                      key={index}
                      className="flex items-center gap-1 bg-accent/20 px-3 py-1 rounded-full text-sm"
                    >
                      {color}
                      <button
                        type="button"
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setAddForm({ ...addForm, colorInput: e.target.value })
                    }
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setAddForm({ ...addForm, sizeInput: e.target.value })
                    }
              ...
              <div className="mb-4">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({ ...editForm, colorInput: e.target.value })
                    }
              ...
              <div className="mb-6">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    onChange={(e) =>
                      setEditForm({ ...editForm, sizeInput: e.target.value })
                    }
